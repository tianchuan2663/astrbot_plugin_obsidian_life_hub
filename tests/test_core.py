...
class CoreTests(unittest.TestCase):
    ...
    def test_plan_triggers(self):
        ...
        upcoming = classify_auto_record("计划 过几天 去灵山岛")
        ...
        self.assertEqual(upcoming.kind, "plan")
        self.assertEqual(upcoming.plan_scope, "短期")
        self.assertEqual(upcoming.content, "去灵山岛")
